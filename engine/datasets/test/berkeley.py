...
class LoadBerkeleyAnnotations(LoadAnnotations):

    def __init__(self):
        super(LoadBerkeleyAnnotations, self).__init__()
...
class BerkeleyDataset(BaseInterSegDataset):

    default_meta_root = 'data/meta-info/berkeley.json'
